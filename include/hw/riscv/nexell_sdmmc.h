...
#define    NEXELL_SDMMC_OFFSET_CTRL           0x000 // Control
#define    NEXELL_SDMMC_OFFSET_PWREN  	 0x004 // Power Enable
#define    NEXELL_SDMMC_OFFSET_CLKDIV	 0x008 // Clock Divider
#define    NEXELL_SDMMC_OFFSET_CLKSRC	 0x00C // Clock Source
#define    NEXELL_SDMMC_OFFSET_CLKENA	 0x010 // Clock Enable
#define    NEXELL_SDMMC_OFFSET_TMOUT	         0x014 // Time-Out
#define    NEXELL_SDMMC_OFFSET_CTYPE	         0x018 // Card Type
#define    NEXELL_SDMMC_OFFSET_BLKSIZ	 0x01C // Block Size
#define    NEXELL_SDMMC_OFFSET_BYTCNT	 0x020 // Byte Count
#define    NEXELL_SDMMC_OFFSET_INTMASK	 0x024 // Interrupt Mask
#define    NEXELL_SDMMC_OFFSET_CMDARG	 0x028 // Command Argument
#define    NEXELL_SDMMC_OFFSET_CMD		 0x02C // Command
#define    NEXELL_SDMMC_OFFSET_RESP   	 0x030 // Response 0
#define    NEXELL_SDMMC_OFFSET_MINTSTS	 0x040 // Masked Interrupt Status
#define    NEXELL_SDMMC_OFFSET_RINTSTS	 0x044 // Raw Interrupt Status
#define    NEXELL_SDMMC_OFFSET_STATUS	 0x048 // Status - Mainly for Debug Purpose
#define    NEXELL_SDMMC_OFFSET_FIFOTH	 0x04C // FIFO Threshold
#define    NEXELL_SDMMC_OFFSET_CDETECT	 0x050 // Card Detect
#define    NEXELL_SDMMC_OFFSET_WRTPRT	 0x054 // Write Protect
#define    NEXELL_SDMMC_OFFSET_GPIO		 0x058 // General Purpose Input/Output
#define    NEXELL_SDMMC_OFFSET_TCBCNT	 0x05C // Transferred CIU card byte count
#define    NEXELL_SDMMC_OFFSET_TBBCNT	 0x060 // Transferred Host Byte Count
#define    NEXELL_SDMMC_OFFSET_DEBNCE	 0x064 // Card Detect Debounce
#define    NEXELL_SDMMC_OFFSET_USRID 	 0x068 // User ID
#define    NEXELL_SDMMC_OFFSET_VERID	         0x06C // Version ID
#define    NEXELL_SDMMC_OFFSET_HCON		 0x070 // Hardware Configuration
#define    NEXELL_SDMMC_OFFSET_UHS_REG	 0x074 // UHS_REG register
#define    NEXELL_SDMMC_OFFSET_RSTn		 0x078 // Hardware reset register
#define    NEXELL_SDMMC_OFFSET__Rev0 	 0x07C
#define    NEXELL_SDMMC_OFFSET_BMOD		 0x080 // Bus Mode
#define    NEXELL_SDMMC_OFFSET_PLDMND	 0x084 // Poll Demand
#define    NEXELL_SDMMC_OFFSET_DBADDR	 0x088 // Descriptor List Base Address
#define    NEXELL_SDMMC_OFFSET_IDSTS 	 0x08C // Internal DMAC Status
#define    NEXELL_SDMMC_OFFSET_IDINTEN	 0x090 // Internal DMAC Interrupt Enable
#define    NEXELL_SDMMC_OFFSET_DSCADDR	 0x094 // Current Host Descriptor Address
#define    NEXELL_SDMMC_OFFSET_BUFADDR	 0x098 // Current Buffer Descriptor Address
#define    NEXELL_SDMMC_OFFSET__Rev1          0x09C // [0x100-0x09C];	0x09C ~ 0x100 reserved area
#define    NEXELL_SDMMC_OFFSET_CARDTHRCTL		0x100 // Card Read Threshold Enable
#define    NEXELL_SDMMC_OFFSET_BACKEND_POWER 	0x104 // Back-end Power
#define    NEXELL_SDMMC_OFFSET_UHS_REG_EXT		0x108 // eMMC 4.5 1.2V
#define    NEXELL_SDMMC_OFFSET_EMMC_DDR_REG		0x10C // eMMC DDR START bit detection control
#define    NEXELL_SDMMC_OFFSET_ENABLE_SHIFT		0x110 // Phase shift control
#define    NEXELL_SDMMC_OFFSET_CLKCTRL		0x114 // External clock phase & delay control
#define    NEXELL_SDMMC_OFFSET__Rev2                 0x118 //[0x200-0x118];	0x118 ~ 0x200
#define    NEXELL_SDMMC_OFFSET_DATA			0x200 // Data
#define    NEXELL_SDMMC_OFFSET__Rev3                 0x204 //[0x400-0x204];	0x204 ~ 0x400
