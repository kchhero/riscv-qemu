...
#ifndef HW_NEXELL_PLIC_H
#define HW_NEXELL_PLIC_H

#include "hw/irq.h"

#define TYPE_NEXELL_PLIC "riscv.nexell.plic"

#define NEXELL_PLIC(obj) \
    OBJECT_CHECK(NexellPLICState, (obj), TYPE_NEXELL_PLIC)
...
typedef struct NexellPLICState {
    /*< private >*/
